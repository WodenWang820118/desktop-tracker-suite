...
- **Gemini**: Antigravity CLI (`agy`) preferred, legacy Gemini CLI compatibility,
...
| `pnpm review:implementation`             | Default implementation review (Antigravity/Gemini 3.5 Flash High) |

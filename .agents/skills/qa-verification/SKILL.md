...
1. **Choose the Verification Path:** Browser-visible or desktop-visible flows use an interactive verification path; backend, CLI, and Electron-runtime changes use smoke tests, task commands, and structured findings.

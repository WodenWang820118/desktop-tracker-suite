...
- For browser-visible or desktop-visible verification requests, use `qa-verification` and `.agents/workflows/verification.md` when concrete target routing is needed.
## Gemini CLI
...
- verification-target and Nx entry summaries

...
- For browser-visible, desktop-visible, backend smoke, or workspace verification requests, use `qa-verification` first. Load `.agents/workflows/verification.md` when concrete verification targets are needed.

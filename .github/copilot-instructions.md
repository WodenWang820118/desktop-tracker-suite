...
- For Angular, React, Vue, NestJS, Express, Java, and Tauri tasks, use `.agents/stack-conventions.md` via `AGENTS.md`.
...
- For browser-verifiable or desktop-visible verification requests, use `qa-verification`; when target routing is needed, follow `.agents/workflows/verification.md`.

...
If browser verification is available and the change is visual or interactive, recommend browser verification rather than relying only on code inspection.
